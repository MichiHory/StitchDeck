...
- **Bezpečnostní sken** — před sloučením prohledá obsah všech souborů na potenciální tajné klíče: API klíče, tokeny, hesla, privátní klíče, connection stringy a další citlivé údaje. Při nálezu zobrazí varovný dialog s tabulkou nálezů (soubor, řádek, typ, detail, maskovaná shoda). Můžete varování ignorovat a pokračovat, nebo sloučení zrušit.
