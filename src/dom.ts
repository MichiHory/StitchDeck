...
export const toggleSecurityScan = document.getElementById('toggleSecurityScan')! as HTMLInputElement;
...
export const ghStatusRepo = document.getElementById('ghStatusRepo')!;
export const ghStatusBranch = document.getElementById('ghStatusBranch')!;
